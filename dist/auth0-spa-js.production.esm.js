  ...
  { target: 'Array', stat: !0, forced: Sr },
  {
    from: function (e) {
      ...
      if (
        ...
        for (i = (o = yr(c, d)).next, n = new s(); !(r = i.call(o)).done; h++)
...
var _r,
  kr,
  Ir,
  Tr = 'undefined' != typeof ArrayBuffer && 'undefined' != typeof DataView,
  Or = ue.f,
  Er = p.Int8Array,
  xr = Er && Er.prototype,
  Cr = p.Uint8ClampedArray,
  Rr = Cr && Cr.prototype,
  jr = Er && Jn(Er),
  Ar = xr && Jn(xr),
  Fr = Object.prototype,
  Kr = Fr.isPrototypeOf,
  Ur = q('toStringTag'),
  Lr = B('TYPED_ARRAY_TAG'),
  Pr = B('TYPED_ARRAY_CONSTRUCTOR'),
  Wr = Tr && !!$n && 'Opera' !== Rt(p.opera),
  Zr = !1,
  Vr = {
    Int8Array: 1,
    Uint8Array: 1,
  ...
  Nr = { BigInt64Array: 8, BigUint64Array: 8 },
  Xr = function (e) {
    if (!E(e)) return !1;
    var t = Rt(e);
    return z(Vr, t) || z(Nr, t);
  };
for (_r in Vr) (Ir = (kr = p[_r]) && kr.prototype) ? le(Ir, Pr, kr) : (Wr = !1);
for (_r in Nr) (Ir = (kr = p[_r]) && kr.prototype) && le(Ir, Pr, kr);
if (
  (!Wr || 'function' != typeof jr || jr === Function.prototype) &&
  ((jr = function () {
    throw TypeError('Incorrect invocation');
  }),
  Wr)
)
  for (_r in Vr) p[_r] && $n(p[_r], jr);
if ((!Wr || !Ar || Ar === Fr) && ((Ar = jr.prototype), Wr))
  for (_r in Vr) p[_r] && $n(p[_r].prototype, Ar);
if ((Wr && Jn(Rr) !== Ar && $n(Rr, Ar), v && !z(Ar, Ur)))
  for (_r in ((Zr = !0),
  Or(Ar, Ur, {
    get: function () {
      return E(this) ? this[Lr] : void 0;
    }
  }),
  Vr))
    p[_r] && le(p[_r], Lr, _r);
var Yr = {
    NATIVE_ARRAY_BUFFER_VIEWS: Wr,
    TYPED_ARRAY_CONSTRUCTOR: Pr,
    TYPED_ARRAY_TAG: Zr && Lr,
    ...
    exportTypedArrayStaticMethod: function (e, t, n) {
      ...
      if (v) {
        if ($n) {
          ...
          if (jr[e] && !n) return;
          try {
            return Ce(jr, e, n ? t : (Wr && jr[e]) || t);
          } catch (e) {}
        }
        for (r in Vr) !(o = p[r]) || (o[e] && !n) || Ce(o, e, t);
      }
    },
    isView: function (e) {
      if (!E(e)) return !1;
      var t = Rt(e);
      return 'DataView' === t || z(Vr, t) || z(Nr, t);
    },
    isTypedArray: Xr,
    TypedArray: jr,
    TypedArrayPrototype: Ar
  },
  zr = q('species'),
  Dr = Yr.TYPED_ARRAY_CONSTRUCTOR,
  Jr = Yr.aTypedArrayConstructor,
  Br = function (e) {
    return Jr(
      ((t = e),
      (n = e[Dr]),
      void 0 === (o = ce(t).constructor) || null == (r = ce(o)[zr]) ? n : dt(r))
    );
    var t, n, r, o;
  },
  Gr = Yr.aTypedArray,
  Mr = [].slice;
(0, Yr.exportTypedArrayMethod)(
  'slice',
  function (e, t) {
    for (
      var n = Mr.call(Gr(this), e, t),
        r = Br(this),
        o = 0,
        i = n.length,
        a = new r(i);
...
var Hr = q('unscopables'),
  qr = Array.prototype;
null == qr[Hr] && ue.f(qr, Hr, { configurable: !0, value: Nt(null) });
var Qr = function (e) {
    qr[Hr][e] = !0;
  },
  $r = We.includes;
tt(
  ...
  yt('String', 'includes');
var eo = xe.set,
  to = xe.getterFor('Array Iterator');
or(
  Array,
  'Array',
  function (e, t) {
    eo(this, { type: 'Array Iterator', target: O(e), index: 0, kind: t });
  },
  function () {
    var e = to(this),
      t = e.target,
  ...
  ro = l(function (e) {
    var t = ue.f,
      ...
      c = (e.exports = {
        ...
        onFreeze: function (e) {
          return no && n && i(e) && !z(e, r) && a(e), e;
        }
      });
    we[r] = !0;
  });
ro.enable, ro.fastKey, ro.getWeakData, ro.onFreeze;
var oo = function (e, t) {
  ...
  io = function (e, t, n) {
    var r,
      ...
      p = ht(t, l, 1 + f + h),
      y = function (e) {
        return r && sr(r, 'normal', e), new oo(!0, e);
      },
      v = function (e) {
        return f
    ...
    if (d) r = e;
      ...
      if (dr(o)) {
        for (i = 0, a = Ke(e.length); a > i; i++)
          if ((c = v(e[i])) && c instanceof oo) return c;
        return new oo(!1);
      }
      r = yr(e, o);
    }
    for (s = r.next; !(u = s.call(r)).done; ) {
      ...
      if ('object' == typeof c && c && c instanceof oo) return c;
    }
    return new oo(!1);
  },
  ao = function (e, t, n) {
  ...
  po = {
    getConstructor: function (e, t, n, r) {
      var o = e(function (e, i) {
          ao(e, o, t),
            ...
            v || (e.size = 0),
            null != i && io(i, e[r], { that: e, AS_ENTRIES: n });
        }),
        i = ho(t),
        a = function (e, t, n) {
          var r,
    ...
    setStrong: function (e, t, n) {
      ...
      or(
        ...
        t,
        function (e, t) {
          fo(this, { type: r, target: e, state: o(e), kind: t, last: void 0 });
        },
        function () {
...
!(function (e, t, n) {
  ...
  if (
    ...
    (s = n.getConstructor(t, e, r, i)), ro.enable();
  else if ($e(e, !0)) {
    var f = new s(),
      d = f[i](o ? {} : -0, 1) != f,
      h = y(function () {
    ...
    v ||
      (((s = t(function (t, n) {
        ...
        return null != n && io(n, o[i], { that: o, AS_ENTRIES: r }), o;
      })).prototype = c),
      (c.constructor = s)),
      ...
      wo._immediateFn(function () {
        ...
        if (null !== n) {
          ...
          try {
            ...
            return void ko(t.promise, e);
          }
          _o(t.promise, r);
        } else (1 === e._state ? _o : ko)(t.promise, e._value);
      }))
    : e._deferreds.push(t);
}
function _o(e, t) {
  try {
    ...
    if (t && ('object' == typeof t || 'function' == typeof t)) {
      var n = t.then;
      if (t instanceof wo) return (e._state = 3), (e._value = t), void Io(e);
...
function ko(e, t) {
  (e._state = 2), (e._value = t), Io(e);
}
function Io(e) {
  2 === e._state &&
    0 === e._deferreds.length &&
    wo._immediateFn(function () {
      e._handled || wo._unhandledRejectionFn(e._value);
    });
  for (var t = 0, n = e._deferreds.length; t < n; t++) So(e, e._deferreds[t]);
  e._deferreds = null;
}
function To(e, t, n) {
...
(wo.prototype.catch = function (e) {
  ...
  (wo.prototype.then = function (e, t) {
    ...
    return So(this, new To(e, t, n)), n;
  }),
  (wo.prototype.finally = yo),
  (wo.all = function (e) {
    return new wo(function (t, n) {
      if (!go(e)) return n(new TypeError('Promise.all accepts an array'));
      var r = Array.prototype.slice.call(e);
      if (0 === r.length) return t([]);
      var o = r.length;
      function i(e, a) {
  ...
  (wo.resolve = function (e) {
    return e && 'object' == typeof e && e.constructor === wo
      ? e
      : new wo(function (t) {
          t(e);
        });
  ...
  (wo.race = function (e) {
    return new wo(function (t, n) {
      if (!go(e)) return n(new TypeError('Promise.race accepts an array'));
      for (var r = 0, o = e.length; r < o; r++) wo.resolve(e[r]).then(t, n);
    });
  }),
  (wo._immediateFn =
  ...
  (wo._unhandledRejectionFn = function (e) {
...
'function' != typeof Eo.Promise
  ? (Eo.Promise = wo)
  : Eo.Promise.prototype.finally
  ? Eo.Promise.allSettled || (Eo.Promise.allSettled = vo)
  : (Eo.Promise.prototype.finally = yo),
  (function (e) {
    function t() {}
    function n(e, t) {
      if (
...
var Co = u(
                  ...
                  case 0:
                    return (
                      ...
                      null === (a = n.getItem(i))
                        ...
                        ? [3, 2]
                        : [4, xo.default().lock(a.iat)]
                    );
                  case 1:
                    r.sent(),
                      this.acquiredIatSet.delete(a.iat),
                      n.removeItem(i),
                      xo.default().unlock(a.iat),
                      e.notifyWaiters(),
                      (r.label = 2);
                  case 2:
                    return [2];
  ...
  Ao = { name: 'auth0-spa-js', version: '1.18.0' },
  Fo = (function (e) {
    function n(t, r) {
      ...
      (r = function (a) {
        if (a.data && 'authorization_response' === a.data.type) {
          if (
            ...
            return n(Fo.fromPayload(a.data.response));
          t(a.data.response);
        }
      }),
  ...
  Xo = function () {
    var e =
      ...
      t = '';
    return (
      Array.from(Vo().getRandomValues(new Uint8Array(43))).forEach(function (
        n
      ) {
...
var Go = function (e, t) {
  ...
  qo = function (e, t, n, r, a, c, s) {
    return (
      void 0 === s && (s = 1e4),
      o(void 0, void 0, void 0, function () {
        return i(this, function (o) {
          return a ? [2, Ho(e, t, n, r, s, a, c)] : [2, Mo(e, r, s)];
        });
      })
    );
  };
    ...
    return i(this, function (i) {
      switch (i.label) {
        ...
        case 1:
          ...
          i.label = 2;
        case 2:
          return i.trys.push([2, 4, , 5]), [4, qo(e, n, a, c, s, u, t)];
        case 3:
        ...
        case 6:
          ...
          if (
            ...
            if (
              ...
              throw new Wo(p, m, v.mfa_token);
            throw new Fo(p || 'request_error', m);
          }
          return [2, v];
      }
    });
                ...
                s,
                {
                  ...
                  headers: {
                    'Content-Type': l
                      ...
                      : 'application/json',
                    'Auth0-Client': btoa(JSON.stringify(u || Ao))
                  }
                },
                t,
                l
...
var ei = function (e) {
  ...
  ti = function () {
    ...
    return ei(e.join(' ').trim().split(/\s+/)).join(' ');
  },
  ni = (function () {
    function e(e, t) {
  ...
  ui = function (e) {
    ...
    var t = (function (e) {
      ...
      var c = JSON.parse(Jo(o)),
        s = { __raw: e },
        u = {};
      return (
        Object.keys(c).forEach(function (e) {
          (s[e] = c[e]), si.includes(e) || (u[e] = c[e]);
        }),
        {
          encoded: { header: r, payload: o, signature: i },
          header: JSON.parse(Jo(r)),
          claims: s,
          user: u
        }
      );
    ...
    if (e.max_age && !ci(t.claims.auth_time))
      throw new Error(
...
u(li), li.encode, li.parse, li.getAll;
var fi = li.get,
  di = li.set,
  hi = li.remove,
  pi = {
  ...
  yi = {
    ...
    save: function (e, t, n) {
      ...
      'https:' === window.location.protocol && (r = { secure: !0 }),
        (null == n ? void 0 : n.daysUntilExpire) &&
          (r.expires = n.daysUntilExpire),
        di('_legacy_' + e, JSON.stringify(t), r),
        pi.save(e, t, n);
    },
    remove: function (e) {
      pi.remove(e), pi.remove('_legacy_' + e);
    }
  },
  vi = {
    get: function (e) {
...
var gi,
  ...
  _i =
    ...
    (wi = !1),
    function (e) {
      return (Si = Si || mi(gi, bi, wi)), new Worker(Si, e);
    }),
  ki = {},
  Ii = (function () {
    function e(e, t) {
    ...
    function e(e) {
      ...
      if (
        ...
        if (
          ...
          !Ei(this.cacheLocation))
        )
          throw new Error(
            'Invalid cache location "' + this.cacheLocation + '"'
          );
        o = Ei(this.cacheLocation)();
      }
      (this.cookieStorage = !1 === e.legacySameSiteCookie ? pi : yi),
      ...
      var i,
        a = e.useCookiesForTransactions ? this.cookieStorage : vi;
      (this.scope = this.options.scope),
        (this.transactionManager = new ai(a, this.options.client_id)),
        (this.cacheManager = new ii(
          o,
          o.allKeys ? null : new Ii(o, this.options.client_id)
        )),
        (this.domainUrl =
        ...
        this.options.useRefreshTokens &&
          (this.scope = ti(this.scope, 'offline_access')),
        'undefined' != typeof window &&
          window.Worker &&
          this.options.useRefreshTokens &&
    ...
    return (
      (e.prototype._url = function (e) {
        var t = encodeURIComponent(
          btoa(JSON.stringify(this.options.auth0Client || Ao))
        );
      ...
      (e.prototype._getParams = function (e, t, o, i, a) {
        ...
        return n(n(n({}, s), e), {
          scope: ti(this.defaultScope, this.scope, e.scope),
          response_type: 'code',
          response_mode: 'query',
          state: t,
          nonce: o,
              ...
              switch (o.label) {
                case 0:
                  return (
                    ...
                    (n = ti(this.defaultScope, this.scope, e.scope)),
                    [
                      4,
          ...
          return i(this, function (n) {
            switch (n.label) {
              ...
              case 2:
                return n.sent(), [3, 4];
              case 3:
                if (((t = n.sent()), !jo.includes(t.error))) throw t;
                return [3, 4];
              case 4:
                return [2];
            }
              ...
              switch (d.label) {
                ...
                case 2:
                  return [
                    4,
                    ((h = function () {
                      return Ti.acquireLock('auth0.lock.getTokenSilently', 5e3);
                    }),
                    (p = 10),
                    void 0 === p && (p = 3),
                    o(void 0, void 0, void 0, function () {
                ...
                case 12:
                  return [4, Ti.releaseLock('auth0.lock.getTokenSilently')];
                case 13:
                  return d.sent(), [7];
                case 14:
                  return [3, 16];
              ...
              switch (r.label) {
                case 0:
                  return (
                    ...
                    (e.scope = ti(this.defaultScope, this.scope, e.scope)),
                    (t = n(n({}, Ro), t)),
                      ...
                      if (
                        ...
                        a && a.close(),
                          n.data.response.error
                            ? t(Fo.fromPayload(n.data.response))
                            : e(n.data.response),
                          clearTimeout(i),
                          window.removeEventListener('message', r, !1),
                          setTimeout(o, 2e3);
...
function ji(e) {
  return o(this, void 0, void 0, function () {
    ...
    return i(this, function (n) {
      switch (n.label) {
        case 0:
          return [4, (t = new Ci(e)).checkSession()];
        case 1:
          return n.sent(), [2, t];
      }
    });
...
export {
  Ci as Auth0Client,
  Ko as AuthenticationError,
  Fo as GenericError,
  oi as InMemoryCache,
  ri as LocalStorageCache,
  Wo as MfaRequiredError,
  Po as PopupCancelledError,
  Lo as PopupTimeoutError,
  Uo as TimeoutError,
  Ri as User
};
